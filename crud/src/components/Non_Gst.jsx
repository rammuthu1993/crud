...
export const Non_Gst = () => {
  ...
  const newRow =  {desc:"",qty:"",unitprice:"",price:""}
   ...
   <div ref={printRef} className='container-fluid'>
     <div className='row py-2'>
       <div className='col-md-6'>
          ...
          <h2 className='text-success'><span className='h1'>E</span>STIMATED BILL</h2> 
          <div>
            ...
            <div className='h6 p-1 gstbg'>
             ...
             <div className='h6 p-1 gstbg'>
                ...
                <select onChange={handleStatechange} style={{width:"50%",height:"20px",fontSize:"14px"}} name="gst" id="gst">
       ...
       <div className='col-md-6'>
        ...
        <div className='float-end'>
          ...
          <table className='p-1'>
            ...
            <tr><th className='bg-success text-white'>INVOICE NO <br /> GSTIN</th><td style={{backgroundColor:"rgba(196, 195, 195, 0.951)"}}>
            </td></tr>
          </table>
          </div>
       ...
       <div>
        ...
        <thead>
         ...
         <tbody id='tab_row'>
          {gstcontent.map((v,i)=>(<tr key={i}>
            ...
            <td className='text-center'><input className="text-center" value={v.price} name="price" type="number" onChange={e=>handleChange(e,i)}/>
            </td>
        ...
        <tfoot id='tab_foot'>
            ...
            <input className="text-center" value={total} type="number" style={{color:"red"}}/></td>
            </tr>
          </tfoot>   
        </table>
       </div>
